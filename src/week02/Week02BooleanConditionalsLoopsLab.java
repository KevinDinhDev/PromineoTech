...
public class Week02BooleanConditionalsLoopsLab {
	...
	public static void main(String[] args) {
		...
		int numberOfRemainingCookies = numberOfCookies % numberOfChildren;
		
		if (numberOfRemainingCookies >=5) {
			System.out.println("Jackpot!");
		} else if (numberOfRemainingCookies < 5) {
			System.out.println("Whoohooo!");
		} else if (numberOfRemainingCookies < 2) {
		...
		*/
		...
		while (backwards > 0) {
			System.out.println(backwards + " " + (backwards % 3));
			backwards--;
		}
